...
class FindMyTownAdapter(context: Context,arrayList: ArrayList<FindMyTownResponse>,recyclerMessageView: RecyclerMessageView):BaseRecyclerMessageViewAdapter<FindMyTownResponse,FindMyTownViewHolder>(context,arrayList,recyclerMessageView) {
