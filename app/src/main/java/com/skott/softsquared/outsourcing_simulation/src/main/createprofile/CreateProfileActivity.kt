...
class CreateProfileActivity :BaseActivity<CreateProfileLayoutBinding>(CreateProfileLayoutBinding::inflate),CreateProfileView{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        context = this
        phonenumber = intent.getStringExtra(context.getString(R.string.sign_in_to_create_profile_phone_number_intent_key))!!.toString()
        ApplicationClass.sSharedPreferences =
            applicationContext.getSharedPreferences(context.getString(R.string.jwt_key), MODE_PRIVATE)
        editor=ApplicationClass.sSharedPreferences.edit()
        nickname=(supportFragmentManager.findFragmentById(R.id.create_profile_content_fragment) as ProfileFragment).profileEditTextListener()
        profilImage=(supportFragmentManager.findFragmentById(R.id.create_profile_content_fragment) as ProfileFragment).profileImageListener()
